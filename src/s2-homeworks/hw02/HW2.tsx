...
export const filterAffairs = (affairs: AffairType [], filter: FilterType): AffairType []  => { // need to fix any
  let filterAffairs = affairs
  if (filter ==="high"){
    filterAffairs = affairs.filter(f=>f.priority === "high")
  }
   if (filter ==="middle"){
    filterAffairs = affairs.filter(f=>f.priority === "middle")
  }
   if (filter ==="low"){
    filterAffairs = affairs.filter(f=>f.priority === "low")
  }
    return filterAffairs // need to fix
}
